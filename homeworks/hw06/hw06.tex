...
\hardsubproblem{[MA] Prove $\expe{\cdot} = \sigsq$. The answer is online but try to do it yourself. (This property is called \qu{unbiasedness} in a statistical inference context.}\spc{12}
...
\extracreditsubproblem{Prove this estimator is \textit{biased} i.e $\expe{\cdot} \neq \sigma$.}\spc{12}
