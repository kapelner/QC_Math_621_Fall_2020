...
\problem\timedsection{5} Let $X\,|\,N=n \sim \binomial{n}{1/2} := \binom{n}{x} \oneover{2^n} \indic{x \in \braces{0,1,...,n}}$ and let $n$ be a realization from $N \sim$ ExtNegBin($\alpha, p$).
