...
\easysubproblem{Consider $X_n \sim U\parens{-\oneover{n}, \oneover{n}}$. Show that $X_n \convd 0$.}\spc{5}

\intermediatesubproblem{Consider $X_n \sim U\parens{-\oneover{n}, \oneover{n}}$. Show that $X_n \convp 0$. For a full proof of $\forall \epsilon$, you need to show it for $\epsilon < 1$ and $\epsilon \geq 1$ separately but since we only care about small epsilon, you can just demonstrate it for $\epsilon < 1$.}\spc{7}
